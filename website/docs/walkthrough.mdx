...
First you'll need to install the [Saasify CLI](https://github.com/saasify-xyz/saasify/tree/master/packages/saasify-cli).
...
Before we get started, you'll need to create a Saasify account.
