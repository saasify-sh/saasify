...
First you'll need to install the [Fin CLI](https://github.com/saasify/saasify).
...
```bash
saasify signup --email <travis@example.com> --password password
```
...
This will take a minute or so to complete, with the end result being a publicly accessible deployment. The deployment URL will be copied to your clipboard and should resemble `https://api.saasify.xyz/1/call/hello-world_f4a0d67bc61f7b5b`.
...
```bash
> http https://api.saasify.xyz/1/call/hello-world_f4a0d67bc61f7b5b
Hello World!
```
...
```bash
> http https://api.saasify.xyz/1/call/hello-world_f4a0d67bc61f7b5b?name=Foo
Hello Foo!
```
...
```bash
> http POST https://api.saasify.xyz/1/call/hello-world_f4a0d67bc61f7b5b name=Nala
Hello Nala!
```
