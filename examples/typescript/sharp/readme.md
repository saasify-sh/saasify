...
<a href="https://transitive-bullshit_sharp_fc28f5dd.saasify.sh">
  <img
...
curl -X POST -d '@example.json' \
  'https://api.saasify.sh/1/call/transitive-bullshit/sharp@fc28f5dd'
```
...
Here's this example as a GET request: [`/?input=https://octodex.github.com/images/original.png&ops[0][op]=jpeg`](https://api.saasify.sh/1/call/transitive-bullshit/sharp@fc28f5dd/?input=https://octodex.github.com/images/original.png&ops[0][op]=jpeg).
