...
If you're interested in OSS sustainability and want to follow along with the progress of Fin, please consider starring the [CLI repo](https://github.com/functional-income/fin) to help the project gain visibility. ⭐️
