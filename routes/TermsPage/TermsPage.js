    ...
    return (
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          ...
          <p>Your continued use of the Website following the posting of revised Terms of Use means that you accept and agree to the changes. You are expected to check this page periodically so you are aware of any changes, as they are binding on you.</p>
          ...
          <ul>
            ...
            <li>If we provide <em>social media features</em> (accessed via our homepage) with certain content, you may take such actions as are enabled by such features.</li>
          </ul>
          <p>You must not:</p>
          <ul>
          ...
          <p>If you are a subscribing organization, you must comply with these Terms, the Privacy Policy and any other agreements between you and Fin that govern your subscription, including pricing terms.</p>
          <p>If you wish to make any use of material on the Website other than that set out in this section, please address your request to: info@functional-income.com</p>
          ...
          <p>Any User Contribution you post to the site will be considered non-confidential and non-proprietary. By providing any User Contribution on the Website, you grant us and our affiliates and service providers, and each of their and our respective licensees, successors and assigns the right to use, reproduce, modify, perform, display, distribute and otherwise disclose to third parties any such material for any purpose consistent with these Terms of Use.</p>
          ...
          <h3><u>Copyright Infringement</u></h3>
          ...
          <p>All purchases through our site or other transactions for the sale of goods, services or information formed through the Website or as a result of visits made by you are governed by our Terms of Sale and pricing terms, which are hereby incorporated into these Terms of Use.</p>
          ...
          <h3><u>Linking to the Website and Social Media Features</u></h3>
          ...
          <h3><u>Geographic Restrictions</u></h3>
          ...
          <h3><u>Limitation on Time to File Claims</u></h3>
          ...
          <p>The Terms of Use, Terms of Sale and our Privacy Policy constitute the sole and entire agreement between you and Fin with respect to the Website and supersede all prior and contemporaneous understandings, agreements, representations and warranties, both written and oral, with respect to the Website.</p>
          <h3><u>Your Comments and Concerns</u></h3>
          <p>This website is operated by Fin Inc.</p>
          ...
          <p>All other feedback, comments, requests for technical support and other communications relating to the Website should be directed to: info@functional-income.com.</p>
        </div>
