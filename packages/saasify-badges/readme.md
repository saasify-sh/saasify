...
[![Puppet Master](https://badges.saasify.sh?text=Use%20Puppet%20Master%20API&cache=2)](https://puppet-master.sh)
...
![Badge with defaults](https://badges.saasify.sh?cache=2)

![Badge with custom text](https://badges.saasify.sh?text=Custom%20CTA&cache=2)
