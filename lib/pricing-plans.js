...
export default [
  ...
  },
  {
    ...
    type: 'primary',
    desc: 'STARTING AT',
    price: `$${(deployment.amountPerBase / 100).toFixed(2)}`,
    interval: 'mo',
    requests: {
      // TODO: make toFixed be dynamic
      price: `$${(deployment.amountPerRequest / 100).toFixed(4)} / call`,
      rateLimit: undefined
    },
    compute: {
      price: `$${(deployment.amountPerCompute / 100).toFixed(4)} / GB-s`,
      rateLimit: undefined
    },
    bandwidth: {
